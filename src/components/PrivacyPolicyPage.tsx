  ...
  <img src="src/assets/meno.png" alt="" />
    ...
    <nav>
      <ul className="space-y-3 ">
        {[
          { href: '#background', text: 'Background', icon: '/img1.png' },
          { href: '#definitions', text: 'Purpose and Applicability', icon: '/img2.png' },
          { href: '#collection', text: 'Definitions', icon: '/img3.png' },
          { href: '#use', text: 'Collection of Information', icon: '/img4.png' },
          { href: '#disclosure', text: 'Use of Information', icon: '/img5.png' },
          { href: '#cookies', text: 'Disclosure and Transfer of Information', icon: '/img6.png' },
          { href: '#security', text: ' Cookies, Web Beacons and Tracking Technologies', icon: '/img7.png' }, 
          { href: '#retention', text: 'Data Security', icon: '/img8.png' },
          { href: '#rights', text: 'Data Retention', icon: '/img9.png' },
          { href: '#changes', text: 'Consent', icon: '/img10.png' },
          { href: '#grievance', text: "Children's Privacy", icon: '/img11.png' },
          { href: '#contact', text: 'Contact Us', icon: '/img12.png' }
        ].map((item) => (
          <li key={item.href}>
            <a
              href={item.href}
